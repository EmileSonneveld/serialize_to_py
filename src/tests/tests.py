...
class MyTest(unittest.TestCase):
    ...
    def test_safe_mode2(self):
        ...
        # self.serialise_test('object of primitives',
        #                     {5: 3.1415, "one": True, "two": False, "thr-ee": None, "four": 1, "six": -17,
        #                      "se ven": "string"},
        ...
        # self.serialise_test('date', datetime.datetime.fromtimestamp(24 * 12 * 3600),
        #                     'datetime.datetime(1970, 1, 13, 1, 0)')
        # self.serialise_test('date 2', datetime.datetime.fromtimestamp(24 * 12 * 3600).isoformat(),
        #                     '1970-01-13T01:00:00')
        ...
        self.serialise_test('array',
                            [True, False, None, 1, 3.1415, -17, 'string'],
                            '[True, False, None, 1, 3.1415, -17, "string"]'
                            )
    ...
    def test_other(self):
        self.serialise_test('simple nested objects', {
            "a": {
                "a1": 0,
                "a2": 0,
            },
